...
class CFFFontSet:
	...
	def fromXML(self, xxx_todo_changeme):
...
class GlobalSubrsIndex(Index):
	...
	def fromXML(self, xxx_todo_changeme1):
...
class FDArrayIndex(TopDictIndex):
	...
	def fromXML(self, xxx_todo_changeme2):
		(name, attrs, content) = xxx_todo_changeme2
		if name != "FontDict":
			return
		fontDict = FontDict()
		for element in content:
...
class CharStrings:
	...
	def fromXML(self, xxx_todo_changeme3):
...
class SimpleConverter:
	...
	def xmlWrite(self, xmlWriter, name, value, progress):
		...
		xmlWriter.newline()
	def xmlRead(self, xxx_todo_changeme4, parent):
		(name, attrs, content) = xxx_todo_changeme4
		return attrs["value"]

class Latin1Converter(SimpleConverter):
	def xmlRead(self, xxx_todo_changeme5, parent):
		(name, attrs, content) = xxx_todo_changeme5
		s = str(attrs["value"], "utf-8")
...
class NumberConverter(SimpleConverter):
	def xmlRead(self, xxx_todo_changeme6, parent):
		(name, attrs, content) = xxx_todo_changeme6
...
class ArrayConverter(SimpleConverter):
	def xmlWrite(self, xmlWriter, name, value, progress):
		...
		xmlWriter.newline()
	def xmlRead(self, xxx_todo_changeme7, parent):
		(name, attrs, content) = xxx_todo_changeme7
		values = attrs["value"].split()
		return list(map(parseNum, values))
...
class TableConverter(SimpleConverter):
	def xmlWrite(self, xmlWriter, name, value, progress):
		...
		xmlWriter.newline()
	def xmlRead(self, xxx_todo_changeme8, parent):
		(name, attrs, content) = xxx_todo_changeme8
		ob = self.getClass()()
		for element in content:
			if isinstance(element, str):
				continue
...
class CharStringsConverter(TableConverter):
	...
	def write(self, parent, value):
		return 0  # dummy value
	def xmlRead(self, xxx_todo_changeme9, parent):
		(name, attrs, content) = xxx_todo_changeme9
		if hasattr(parent, "ROS"):
...
class CharsetConverter:
	...
	def xmlWrite(self, xmlWriter, name, value, progress):
		...
		xmlWriter.newline()
	def xmlRead(self, xxx_todo_changeme10, parent):
		(name, attrs, content) = xxx_todo_changeme10
		if 0:
...
class EncodingConverter(SimpleConverter):
	...
	def xmlRead(self, xxx_todo_changeme11, parent):
		(name, attrs, content) = xxx_todo_changeme11
		if "name" in attrs:
			return attrs["name"]
		encoding = [".notdef"] * 256
		for element in content:
...
class FDArrayConverter(TableConverter):
	...
	def xmlRead(self, xxx_todo_changeme12, parent):
		(name, attrs, content) = xxx_todo_changeme12
...
class FDSelectConverter:
	...
	def xmlRead(self, xxx_todo_changeme13, parent):
		(name, attrs, content) = xxx_todo_changeme13
...
class ROSConverter(SimpleConverter):
	...
	def xmlRead(self, xxx_todo_changeme14, parent):
		(name, attrs, content) = xxx_todo_changeme14
...
class BaseDict:
	...
	def fromXML(self, xxx_todo_changeme15):
		(name, attrs, content) = xxx_todo_changeme15
		conv = self.converters[name]
...
class TopDict(BaseDict):
	...
	def decompileAllCharStrings(self, progress):
		...
		i = 0
		for charString in list(self.CharStrings.values()):
			try:
